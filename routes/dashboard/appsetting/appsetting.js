...
var userOnesignalModels = require('../../../models/usersonesignal');
    ...
    try {
        ...
        appsettingModels.findOne({
            ...
            if (dataOne) {
                ...
                // check alluser onesignal  
                if (dataOne.oneSignalID != req.body.onesignalid || dataOne.oneSignalUserID != req.body.onesignaluserid|| dataOne.oneSignalAPIKey != req.body.onesignalapikey){
                    userOnesignalModels.remove({ idApp: req.body.idapp}).exec();
                }
